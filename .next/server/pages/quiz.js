...
function QuizPage() {
  ...
  const question = _db_json__WEBPACK_IMPORTED_MODULE_4__.questions[0];
  ...
  }, "Pergunta 1 de ", `${_db_json__WEBPACK_IMPORTED_MODULE_4__.questions.length}`)), __jsx("img", {
    src: question.image,
    style: {
      width: '100%',
      height: '150px',
